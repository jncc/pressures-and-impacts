...
L5_agg.columns = ['Level_5', 'Pressure', 'SubregionName', 'Sensitivity']
...
L5_all = L5_orig_sub.append(L5_agg_sens, sort=True)
...
L5_export = L5_export.drop(['Sensitivity'], axis=1, inplace=False)
