...
UKSM = pd.read_csv(r"Z:\Marine\Evidence\PressuresImpacts\6. Sensitivity\SA's Contracts\C16-0257-105 Biogeographical Regional Contract\BioregionsAutomation_2019\Automation_InputDataCopies_LM\UKSeaMap_Attributes\UKSM18_BioregionsIntersection_Attributes.csv")
...
##########################
# [THIS SECTION IS WRITTEN IN PYTHON AND SHOULD BE EXaECUTED FROM A CONSOLE / IDE]
##########################
...
#        JNCC biotope codes
MR_BiotopesDB_Merge = pd.merge(Biotopes_DB_Slice, MR_evidence_merge, on=['EUNIS code', 'JNCC biotope code'], how='outer')
...
existing_bioregions2017 = pd.read_excel(r'J:\GISprojects\Marine\Sensitivity\MarESA aggregation\Aggregation_InputData\Aggregation_InputData\Existing_Bioregions_extract_DoNotDelete.xlsx', 'Bioregions_extract')
...
OldBioExtract = pd.read_excel(r'J:\GISprojects\Marine\Sensitivity\MarESA aggregation\Aggregation_InputData\Aggregation_InputData\Existing_Bioregions_extract_DoNotDelete.xlsx', 'Bioregions_extract')
...
UpdatedBioExtract = UpdatedBioExtract.loc[~UpdatedBioExtract['EUNIS_code'].isin(biotopes)]

##################################

# Export new bioregions extract for aggregation process
# Define folder file path to be saved into
outpath = r"J:\GISprojects\Marine\Sensitivity\MarESA aggregation\Aggregation_InputData\Aggregation_InputData"
